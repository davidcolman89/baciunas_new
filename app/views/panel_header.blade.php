...
<div class="pull-right">
    ...
    <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
        <li class="">
            <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                <img src="{{ URL::asset('smartadmin/img/avatars/sunny.png') }}" alt="John Doe" class="online"/>
            </a>
            <ul class="dropdown-menu pull-right">
                ...
                <li class="divider"></li>
                <li>
                    <a href="{{ URL::asset('smartadmin/profile.html') }}" class="padding-10 padding-top-0 padding-bottom-0"> <i
                ...
                <li class="divider"></li>
                <li>
                    <a href="{{ URL::asset('smartadmin/login.html') }}" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i
    ...
    <div id="logout" class="btn-header transparent pull-right">
            <span> <a href="{{ URL::route('logout') }}" title="Sign Out" data-action="userLogout"
