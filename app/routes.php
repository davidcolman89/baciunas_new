...
Route::group(array('before' => 'auth'), function () {
	...
	Route::get('politicasPrecio/getProductosByCliente/{idCliente}', array('as'=>'politicasPrecio.getProductoByCliente','uses'=>'PoliticasPrecioController@getProductosByCliente'));
