...
Route::group(array('before' => 'auth'), function () {
	...
	Route::get('politicasPrecio/getProductoByCliente/{idCliente}', array('as'=>'politicasPrecio.getProductoByCliente','uses'=>'PoliticasPrecioController@getProductosByCliente'));
